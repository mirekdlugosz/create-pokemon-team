...
GEN8_DEX = ["grookey", "thwackey", "rillaboom", "scorbunny", "raboot",
            ...
            "dugtrioalola", "drilbur", "excadrill", "roggenrola", "boldore",
            "gigalith", "timburr", "gurdurr", "conkeldurr", "woobat",
            "swoobat", "noibat", "noivern", "onix", "steelix", "arrokuda",
            "barraskewda", "meowth", "meowthgalar", "meowthalola",
            ...
            "shelmet", "accelgor", "elgyem", "beheeyem", "cubchoo", "beartic",
            "rufflet", "braviary", "vullaby", "mandibuzz", "skorupi",
            "drapion", "litwick", "lampent", "chandelure", "inkay", "malamar",
            "sneasel", "weavile", "sableye", "mawile", "maractus", "sigilyph",
            "riolu", "lucario", "torkoal", "mimikyu", "cufant", "copperajah",
            "qwilfish", "frillish", "jellicent", "mareanie", "toxapex",
            "cramorant", "toxel", "toxtricity", "toxtricitylowkey",
            "silicobra", "sandaconda", "hippopotas", "hippowdon", "durant",
            "heatmor", "helioptile", "heliolisk", "hawlucha", "trapinch",
            "vibrava", "flygon", "axew", "fraxure", "haxorus", "yamaskgalar",
            "runerigus", "cofagrigus", "honedge", "doublade", "aegislash",
            "ponyta", "ponytagalar", "rapidash", "rapidashgalar", "sinistea",
            "polteageist", "indeedee", "indeedeef", "phantump", "trevenant",
            "morelull", "shiinotic", "oranguru", "passimian", "morpeko",
            "falinks", "drampa", "turtonator", "togedemaru", "snom",
            ...
            "tyranitar", "deino", "zweilous", "hydreigon", "goomy", "sliggoo",
            "goodra", "jangmoo", "hakamoo", "kommoo", "dreepy", "drakloak",
            "dragapult", "zacian", "zaciancrowned", "zamazenta",
            ...
            "brionne", "primarina", "cosmog", "cosmoem", "solgaleo", "lunala",
            "necrozma", "necrozmaduskmane", "necrozmadawnwings", "marshadow",
            "zeraora", "meltan", "melmetal", "buneary", "lopunny", "happiny",
            "chansey", "blissey", "igglybuff", "jigglypuff", "wigglytuff",
            "fomantis", "lurantis", "fletchling", "fletchinder", "talonflame",
            "shinx", "luxio", "luxray", "klefki", "abra", "kadabra",
            "alakazam", "tentacool", "tentacruel", "dunsparce", "bouffalant",
            "lickitung", "lickilicky", "druddigon", "venipede", "whirlipede",
            "scolipede", "foongus", "amoonguss", "comfey", "tangela",
            "tangrowth", "zorua", "zoroark", "staryu", "starmie", "emolga",
            "dedenne", "magnemite", "magneton", "magnezone", "carvanha",
            "sharpedo", "lillipup", "herdier", "stoutland", "tauros",
            "miltank", "scyther", "scizor", "pinsir", "heracross", "sandygast",
            "palossand", "azurill", "marill", "azumarill", "poliwag",
            "poliwhirl", "poliwrath", "politoed", "psyduck", "golduck",
            "whismur", "loudred", "exploud", "skarmory", "rockruff",
            "lycanroc", "lycanrocmidnight", "lycanrocdusk", "mienfoo",
            "mienshao", "sandshrew", "sandshrewalola", "sandslash",
            "sandslashalola", "cubone", "marowak", "marowakalola",
            "kangaskhan", "sandile", "krokorok", "krookodile", "larvesta",
            "volcarona", "skrelp", "dragalge", "clauncher", "clawitzer",
            "horsea", "seadra", "kingdra", "petilil", "lilligant", "exeggcute",
            "exeggutor", "exeggutoralola", "porygon", "porygon2", "porygonz",
            "magearna", "kubfu", "urshifu", "urshifurapidstrike", "zarude",
            "nidoranf", "nidorina", "nidoqueen", "nidoranm", "nidorino",
            "nidoking", "zubat", "golbat", "crobat", "jynx", "smoochum",
            "electabuzz", "magmar", "elekid", "magby", "electivire",
            "magmortar", "omanyte", "omastar", "kabuto", "kabutops",
            "aerodactyl", "articuno", "articunogalar", "zapdos", "zapdosgalar",
            "moltres", "moltresgalar", "dratini", "dragonair", "dragonite",
            "raikou", "entei", "suicune", "lugia", "hooh", "treecko",
            "grovyle", "sceptile", "torchic", "combusken", "blaziken",
            "mudkip", "marshtomp", "swampert", "aron", "lairon", "aggron",
            "swablu", "altaria", "lileep", "cradily", "anorith", "armaldo",
            "absol", "spheal", "sealeo", "walrein", "relicanth", "bagon",
            "shelgon", "salamence", "beldum", "metang", "metagross",
            "regirock", "regice", "registeel", "regieleki", "regidrago",
            "latias", "latios", "kyogre", "groudon", "rayquaza", "spiritomb",
            "gible", "gabite", "garchomp", "uxie", "mesprit", "azelf",
            ...
            "landorus", "genesect", "tyrunt", "tyrantrum", "amaura", "aurorus",
            "carbink", "xerneas", "yveltal", "zygarde", "diancie", "volcanion",
            "tapukoko", "tapulele", "tapubulu", "tapufini", "nihilego",
