...
GEN8_DEX = ["grookey", "thwackey", "rillaboom", "scorbunny", "raboot",
            ...
            "zigzagoongalar", "linoonegalar", "obstagoon", "wooloo",
            "dubwool", "lotad", "lombre", "ludicolo", "seedot", "nuzleaf",
            "shiftry", "chewtle", "drednaw", "purrloin", "liepard", "yamper",
            "boltund", "bunnelby", "diggersby", "minccino", "cinccino",
            "bounsweet", "steenee", "tsareena", "oddish", "gloom", "vileplume",
            "bellossom", "budew", "roselia", "roserade", "wingull", "pelipper",
            "joltik", "galvantula", "electrike", "manectric", "vulpix",
            "ninetales", "growlithe", "arcanine", "vanillite", "vanillish",
            "vanilluxe", "swinub", "piloswine", "mamoswine", "delibird",
            "snorunt", "glalie", "froslass", "baltoy", "claydol", "mudbray",
            "mudsdale", "dwebble", "crustle", "golett", "golurk", "munna",
            "musharna", "natu", "xatu", "stufful", "bewear", "snover",
            "abomasnow", "krabby", "kingler", "wooper", "quagsire",
            "corphish", "crawdaunt", "nincada", "ninjask", "shedinja",
            "tyrogue", "hitmonlee", "hitmonchan", "hitmontop", "pancham",
            "pangoro", "klink", "klang", "klinklang", "combee", "vespiquen",
            "bronzor", "bronzong", "ralts", "kirlia", "gardevoir", "gallade",
            "drifloon", "drifblim", "gossifleur", "eldegoss", "cherubi",
            "cherrim", "stunky", "skuntank", "tympole", "palpitoad",
            "seismitoad", "duskull", "dusclops", "dusknoir", "machop",
            "machoke", "machamp", "gastly", "haunter", "gengar", "magikarp",
            "gyarados", "goldeen", "seaking", "remoraid", "octillery",
            "shellder", "cloyster", "feebas", "milotic", "basculin",
            "wishiwashi", "pyukumuku", "trubbish", "garbodor", "sizzlipede",
            "centiskorch", "rolycoly", "carkol", "coalossal", "diglett",
            "dugtrio", "drilbur", "excadrill", "roggenrola", "boldore",
            "gigalith", "timburr", "gurdurr", "conkeldurr", "woobat",
            "swoobat", "noibat", "noivern", "onix", "steelix", "arrokuda",
            "barraskewda", "meowthgalar", "perrserker", "persian", "milcery",
            "alcremie", "cutiefly", "ribombee", "ferroseed", "ferrothorn",
            "pumpkaboo", "gourgeist", "pichu", "pikachu", "raichu", "eevee",
            ...
            "farfetchdgalar", "sirfetchd", "chinchou", "lanturn", "croagunk",
            "toxicroak", "scraggy", "scrafty", "stunfiskgalar", "shuckle",
            "barboach", "whiscash", "shellos", "gastrodon", "wimpod",
            "golisopod", "binacle", "barbaracle", "corsolagalar", "cursola",
            "impidimp", "morgrem", "grimmsnarl", "hatenna", "hattrem",
            "hatterene", "salandit", "salazzle", "pawniard", "bisharp",
            "throh", "sawk", "koffing", "weezinggalar", "bonsly", "sudowoodo",
            "cleffa", "clefairy", "clefable", "togepi", "togetic", "togekiss",
            ...
            "skorupi", "drapion", "litwick", "lampent", "chandelure",
            "inkay", "malamar", "sneasel", "weavile", "sableye", "mawile",
            "maractus", "sigilyph", "riolu", "lucario", "torkoal", "mimikyu",
            "cufant", "copperajah", "qwilfish", "frillish", "jellicent",
            "mareanie", "toxapex", "cramorant", "toxel", "toxtricity",
            "toxtricitylowkey", "silicobra", "sandaconda", "hippopotas",
            "hippowdon", "durant", "heatmor", "helioptile", "heliolisk",
            "hawlucha", "trapinch", "vibrava", "flygon", "axew", "fraxure",
            "haxorus", "yamaskgalar", "runerigus", "cofagrigus", "honedge",
            "doublade", "aegislash", "ponytagalar", "rapidashgalar",
