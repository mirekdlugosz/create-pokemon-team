...
GEN8_DEX = ["grookey", "thwackey", "rillaboom", "scorbunny", "raboot",
            ...
            "slowbro", "slowbrogalar", "slowking", "bulbasaur", "ivysaur",
            "venusaur", "squirtle", "wartortle", "blastoise", "mew", "mewtwo",
            "celebi", "jirachi", "cobalion", "terrakion", "virizion",
            "reshiram", "zekrom", "kyurem", "kyuremblack", "kyuremwhite",
            "keldeo", "rowlet", "dartrix", "decidueye", "litten", "torracat",
            "incineroar", "popplio", "brionne", "primarina", "cosmog",
            "cosmoem", "solgaleo", "lunala", "necrozma", "necrozmaduskmane",
            "necrozmadawnwings", "marshadow", "zeraora", "meltan", "melmetal",
            "buneary", "lopunny", "happiny", "chansey", "blissey", "igglybuff",
            "jigglypuff", "wigglytuff", "fomantis", "lurantis", "fletchling",
            "fletchinder", "talonflame", "shinx", "luxio", "luxray", "klefki",
            "abra", "kadabra", "alakazam", "tentacool", "tentacruel",
            "dunsparce", "bouffalant", "lickitung", "lickilicky", "druddigon",
            "venipede", "whirlipede", "scolipede", "foongus", "amoonguss",
            "comfey", "tangela", "tangrowth", "zorua", "zoroark", "staryu",
            "starmie", "emolga", "dedenne", "magnemite", "magneton",
            "magnezone", "carvanha", "sharpedo", "lillipup", "herdier",
            "stoutland", "tauros", "miltank", "scyther", "scizor", "pinsir",
            "heracross", "sandygast", "palossand", "azurill", "marill",
            "azumarill", "poliwag", "poliwhirl", "poliwrath", "politoed",
            "psyduck", "golduck", "whismur", "loudred", "exploud", "skarmory",
            "rockruff", "lycanroc", "lycanrocmidnight", "lycanrocdusk",
            "mienfoo", "mienshao", "sandshrew", "sandshrewalola", "sandslash",
