...
GEN8_DEX = ["grookey", "thwackey", "rillaboom", "scorbunny", "raboot",
            ...
            "rookidee", "corvisquire", "corviknight", "skwovet",
            "greedent", "pidove", "tranquill", "unfezant", "nickit",
            "thievul", "zigzagoongalar", "linoonegalar", "obstagoon",
            "wooloo", "dubwool", "lotad", "lombre", "ludicolo", "seedot",
            "nuzleaf", "shiftry", "chewtle", "drednaw", "purrloin",
            ...
            "electrike", "manectric", "vulpix", "ninetales", "growlithe",
            "arcanine", "vanillite", "vanillish", "vanilluxe", "swinub",
            "piloswine", "mamoswine", "delibird", "snorunt", "glalie",
            "froslass", "baltoy", "claydol", "mudbray", "mudsdale", "dwebble",
            "crustle", "golett", "golurk", "munna", "musharna", "natu", "xatu",
            "stufful", "bewear", "snover", "abomasnow", "krabby", "kingler",
            "wooper", "quagsire", "corphish", "crawdaunt", "nincada",
            "ninjask", "shedinja", "tyrogue", "hitmonlee", "hitmonchan",
            "hitmontop", "pancham", "pangoro", "klink", "klang", "klinklang",
            "combee", "vespiquen", "bronzor", "bronzong", "ralts", "kirlia",
            "gardevoir", "gallade", "drifloon", "drifblim", "gossifleur",
            "eldegoss", "cherubi", "cherrim", "stunky", "skuntank", "tympole",
            "palpitoad", "seismitoad", "duskull", "dusclops", "dusknoir",
            "machop", "machoke", "machamp", "gastly", "haunter", "gengar",
            "magikarp", "gyarados", "goldeen", "seaking", "remoraid",
            "octillery", "shellder", "cloyster", "feebas", "milotic",
            "basculin", "wishiwashi", "pyukumuku", "trubbish", "garbodor",
            "sizzlipede", "centiskorch", "rolycoly", "carkol", "coalossal",
            "diglett", "dugtrio", "drilbur", "excadrill", "roggenrola",
            "boldore", "gigalith", "timburr", "gurdurr", "conkeldurr",
            "woobat", "swoobat", "noibat", "noivern", "onix", "steelix",
            "arrokuda", "barraskewda", "meowth", "meowthgalar", "perrserker",
            "persian", "milcery", "alcremie", "cutiefly", "ribombee",
            "ferroseed", "ferrothorn", "pumpkaboo", "gourgeist", "pichu",
            "pikachu", "raichu", "eevee", "vaporeon", "jolteon", "flareon",
            "espeon", "umbreon", "leafeon", "glaceon", "sylveon", "applin",
            "flapple", "appletun", "espurr", "meowstic", "meowsticf",
            "swirlix", "slurpuff", "spritzee", "aromatisse", "dewpider",
            "araquanid", "wynaut", "wobbuffet", "farfetchdgalar", "sirfetchd",
            "chinchou", "lanturn", "croagunk", "toxicroak", "scraggy",
            "scrafty", "stunfiskgalar", "shuckle", "barboach", "whiscash",
            "shellos", "gastrodon", "wimpod", "golisopod", "binacle",
            "barbaracle", "corsolagalar", "cursola", "impidimp", "morgrem",
            "grimmsnarl", "hatenna", "hattrem", "hatterene", "salandit",
            "salazzle", "pawniard", "bisharp", "throh", "sawk", "koffing",
            "weezinggalar", "bonsly", "sudowoodo", "cleffa", "clefairy",
            "clefable", "togepi", "togetic", "togekiss", "munchlax", "snorlax",
            "cottonee", "whimsicott", "rhyhorn", "rhydon", "rhyperior",
            "gothita", "gothorita", "gothitelle", "solosis", "duosion",
            "reuniclus", "karrablast", "escavalier", "shelmet", "accelgor",
            "elgyem", "beheeyem", "cubchoo", "beartic", "rufflet", "braviary",
            "vullaby", "mandibuzz", "skorupi", "drapion", "litwick", "lampent",
            "chandelure", "inkay", "malamar", "sneasel", "weavile", "sableye",
            "mawile", "maractus", "sigilyph", "riolu", "lucario", "torkoal",
            "mimikyu", "cufant", "copperajah", "qwilfish", "frillish",
            "jellicent", "mareanie", "toxapex", "cramorant", "toxel",
            "toxtricity", "toxtricitylowkey", "silicobra", "sandaconda",
            "hippopotas", "hippowdon", "durant", "heatmor", "helioptile",
            "heliolisk", "hawlucha", "trapinch", "vibrava", "flygon", "axew",
            "fraxure", "haxorus", "yamaskgalar", "runerigus", "cofagrigus",
            "honedge", "doublade", "aegislash", "ponytagalar", "rapidashgalar",
            "sinistea", "polteageist", "indeedee", "indeedeef", "phantump",
            "trevenant", "morelull", "shiinotic", "oranguru", "passimian",
            "morpeko", "falinks", "drampa", "turtonator", "togedemaru",
            "snom", "frosmoth", "clobbopus", "grapploct", "pincurchin",
            ...
            "rotom", "ditto", "dracozolt", "arctozolt", "dracovish",
            "arctovish", "charmander", "charmeleon", "charizard", "typenull",
            "silvally", "silvallybug", "silvallydark", "silvallydragon",
            "silvallyelectric", "silvallyfairy", "silvallyfighting",
            "silvallyfire", "silvallyflying", "silvallyghost", "silvallygrass",
            "silvallyground", "silvallyice", "silvallypoison",
            "silvallypsychic", "silvallyrock", "silvallysteel",
